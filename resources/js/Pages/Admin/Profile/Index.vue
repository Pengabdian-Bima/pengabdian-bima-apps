        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm flex flex-col justify-between">
          <div>
            <div class="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
              <div class="w-16 h-16 bg-gradient-to-br from-primary to-primary-dark rounded-2xl flex items-center justify-center shadow-lg shadow-primary/20 shrink-0">
              ...
              <div>
                ...
                <span class="inline-flex items-center gap-1 mt-1 px-2.5 py-0.5 bg-primary/10 text-primary text-xs font-medium rounded-full">
                  <Icon :icon="user.role === 'kasir' ? 'mdi:cash-register' : 'mdi:shield-crown'" class="text-sm" />
                  {{ user.role === 'kasir' ? 'Kasir' : 'Administrator' }}
                </span>
              </div>
            </div>
            ...
            <form @submit.prevent="submitProfile" class="space-y-4">
              ...
              <button type="submit" :disabled="profileForm.processing"
                class="w-full py-2.5 bg-gradient-to-r from-primary to-primary-dark text-white font-semibold rounded-xl hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer mt-4">
