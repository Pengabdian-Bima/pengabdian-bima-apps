  ...
  <AdminLayout>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
      <table class="w-full text-sm">
        <thead><tr class="bg-gray-50 text-left"><th class="px-4 py-3 font-medium text-gray-500">Produk</th><th class="px-4 py-3 font-medium text-gray-500">Kategori</th><th class="px-4 py-3 font-medium text-gray-500">Stok</th><th class="px-4 py-3 font-medium text-gray-500">Min Stok</th><th class="px-4 py-3 font-medium text-gray-500">Status</th><th class="px-4 py-3 font-medium text-gray-500">Aksi</th></tr></thead>
        <tbody>
